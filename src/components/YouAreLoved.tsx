...
interface YouAreLovedProps {
  firstName: string;
  message: string;
}

const YouAreLoved: React.FC(<YouAreLovedProps>) = ({ firstName, message }) => {
  return (
    <div className="bg-cherryRed h-screen flex justify-center items-center font-rubik">
      ...
      <div>
        <h1 className="text-white text-2xl">Reminder: You are loved {firstName}</h1>
